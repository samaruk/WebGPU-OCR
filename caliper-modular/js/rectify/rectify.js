...
import { detectPageQuad as getPageQuad } from './detectPageQuad.js';
...
export function rectifyPerspective(canvas){
  ...
  // perspective test — opposite edges of a flat, square-on page are
  // equal in length. Only a genuinely keystoned quad is worth warping;
  // a merely rotated page has keystone ~= 0 and is left to the deskew
